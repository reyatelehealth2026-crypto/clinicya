 ...
 *
 * Duplicated from packages/db/tests/helpers/fakeMysqlPool.ts on purpose —
 * kept package/app-local, same as packages/tenant/tests/helpers/fakeMysqlPool.ts's
 * own duplication of it (test-only code, not worth a shared devDependency
 * across a workspace boundary this batch doesn't own).
 */
