...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/safe-alternatives
 * Route Handler (port of api/inbox-v2.php's
 * `case 'safe_alternatives': case 'safe-alternatives': case 'get_safe_alternatives':`,
 * lines ~1478-1508, backed by `DrugRecommendEngineService::getSafeAlternatives()`.
 *
