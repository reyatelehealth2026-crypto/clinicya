...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/ghost-draft
 * Route Handler (port of api/inbox-v2.php's `case 'ghost_draft': case
 * 'ghost-draft': case 'generate_draft':`, lines ~428-469).
 *
