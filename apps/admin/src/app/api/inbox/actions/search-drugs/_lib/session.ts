...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/search-drugs
 * Route Handler (port of api/inbox-v2.php's `case 'search_drugs': case
 * 'search-drugs':`, lines ~617-699).
 *
