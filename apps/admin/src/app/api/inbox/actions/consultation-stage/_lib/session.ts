...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/consultation-stage
 * Route Handler (port of api/inbox-v2.php's `case 'consultation_stage': case
 * 'consultation-stage': case 'detect_stage':`, lines ~1570-1598, backed by
 * `ConsultationAnalyzerService::detectStage()`).
 *
