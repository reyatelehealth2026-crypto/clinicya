...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/drug-inventory
 * Route Handler (port of api/inbox-v2.php's `case 'drug_inventory': case
 * 'drug-inventory': case 'get_drug_inventory':`, lines ~986-1011, backed by
 * `PharmacyIntegrationService::getDrugInventory()`).
 *
 ...
 * from sibling action families without cross-imports.
 */
