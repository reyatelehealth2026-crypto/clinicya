...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/get-performance-metrics
 * Route Handler (port of api/inbox-v2.php's `case 'getPerformanceMetrics': case
 * 'get_performance_metrics':`, lines ~2910-2954, backed by
 * `PerformanceMetricsService::getAllMetricStats()`/`getErrorRate()`).
 *
