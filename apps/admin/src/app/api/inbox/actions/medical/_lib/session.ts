...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/medical
 * Route Handler. Ports inbox-v2.php's `case 'save_medical':` (lines
 * 444-464), the same-page AJAX action gated on
 ...
 * keeps api/inbox/actions/medical/** independently editable from sibling
 * action families without cross-imports.
 */
