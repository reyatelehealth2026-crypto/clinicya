 ...
 * /api/inbox/actions/get-assignment Route Handler (port of
 ...
 * actions/{tags,notes,medical,send-message,get-admins,assign-conversation,unassign-conversation}/_lib/session.ts
 ...
 * medical/send-message/get-admins/assign-conversation/unassign-conversation
 ...
 * keeps api/inbox/actions/get-assignment/** independently editable from
 * sibling action families (get-admins, assign-conversation,
 * unassign-conversation included) without cross-imports.
 */
