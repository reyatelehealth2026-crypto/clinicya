...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/prescription-history
 * Route Handler (port of api/inbox-v2.php's
 * `case 'prescription_history': case 'prescription-history':`, lines ~1126-1155, backed by
 * `PharmacyIntegrationService::getUserPrescriptionHistory()`).
 *
