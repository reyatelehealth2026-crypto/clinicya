...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/log-performance-metric
 * Route Handler (port of api/inbox-v2.php's `case 'logPerformanceMetric': case
 * 'log_performance_metric':`, lines ~2845-2904, backed by
 * `PerformanceMetricsService::logMetric()`).
 *
