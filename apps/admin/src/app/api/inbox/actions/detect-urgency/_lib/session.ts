...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/detect-urgency
 * Route Handler (port of api/inbox-v2.php's `case 'detect_urgency': case
 * 'detect-urgency':`, lines ~1648-1675, backed by
 * `ConsultationAnalyzerService::detectUrgency()`).
 *
