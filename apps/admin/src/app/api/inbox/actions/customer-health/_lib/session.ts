...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/customer-health
 * Route Handler (port of api/inbox-v2.php's `case 'customer_health': case
 * 'customer-health': case 'get_customer_health':`, lines ~329-357).
 *
