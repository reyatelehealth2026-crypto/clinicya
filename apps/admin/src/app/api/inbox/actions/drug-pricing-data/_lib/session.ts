...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/drug-pricing-data
 * Route Handler (port of api/inbox-v2.php's `case 'drug_pricing_data': case
 * 'drug-pricing-data':`, lines ~1022-1046, backed by
 * `PharmacyIntegrationService::getDrugPricing()`).
 *
