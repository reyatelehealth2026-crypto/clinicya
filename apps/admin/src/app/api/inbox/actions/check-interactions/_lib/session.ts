...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/check-interactions
 * Route Handler (port of api/inbox-v2.php's
 * `case 'check_interactions': case 'check-interactions':`, lines ~881-906, backed by
 * `PharmacyIntegrationService::checkDrugInteractions()`, imported read-only from
 * the already-merged `../../patient-profile/_lib/patientProfile.ts`).
 *
