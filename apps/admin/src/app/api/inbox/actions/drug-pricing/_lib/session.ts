...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/drug-pricing
 * Route Handler (port of api/inbox-v2.php's `case 'drug_pricing': case
 * 'drug-pricing': case 'calculate_margin':`, lines ~705-770 — the INLINE-SQL
 * action, distinct from `drug-pricing-data`).
 *
