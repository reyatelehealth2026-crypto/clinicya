...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/classify-customer
 * Route Handler (port of api/inbox-v2.php's `case 'classify_customer': case
 * 'classify-customer':`, lines ~363-391).
 *
