 ...
 * POST /api/inbox/actions/mark-all-read Route Handler. Ports
 * api/inbox-v2.php's `case 'mark_all_read':` (lines 2414-2431).
 *
 * Same "who is logged in + which tenant DB" gate as the sibling
 * api/inbox/actions/{tags,medical,notes,send-message}/_lib/session.ts
 ...
 * Requires any of the six TenantRole values — mark_all_read has no
 ...
 * ownership boundary keeps api/inbox/actions/mark-all-read/**,
