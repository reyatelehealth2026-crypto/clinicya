...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/check-allergy
 * Route Handler (port of api/inbox-v2.php's
 * `case 'check_allergy': case 'check-allergy':`, lines ~1088-1120, backed by
 * `PharmacyIntegrationService::checkUserAllergy()`).
 *
