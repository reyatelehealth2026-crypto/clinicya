...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/drug-card
 * Route Handler (port of api/inbox-v2.php's
 * `case 'drug_card': case 'drug-card': case 'generate_drug_card':`, lines ~1447-1475, backed by
 * `DrugRecommendEngineService::generateDrugCard()`.
 *
