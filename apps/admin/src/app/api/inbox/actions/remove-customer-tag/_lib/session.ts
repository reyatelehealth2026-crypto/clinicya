...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/remove-customer-tag
 * Route Handler (port of api/inbox-v2.php's `case 'remove_customer_tag':`,
 * lines ~2105-2130).
 *
 ...
 * api/inbox/actions/remove-customer-tag/** independently editable from
 * `actions/assign-tag/**` and `actions/tags/**` (both out of scope this
 * round).
 */
