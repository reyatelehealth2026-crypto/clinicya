...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/learn-draft
 * Route Handler (port of api/inbox-v2.php's `case 'learn_draft': case
 * 'learn-draft':`, lines ~475-512).
 *
