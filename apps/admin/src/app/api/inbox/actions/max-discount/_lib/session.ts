...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/max-discount
 * Route Handler (port of api/inbox-v2.php's `case 'max_discount': case
 * 'max-discount':`, lines ~776-801).
 *
