...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/analyze-drug
 * Route Handler (port of api/inbox-v2.php's `case 'analyze_drug': case
 * 'analyze-drug':`, lines ~240-276, backed by
 * `PharmacyImageAnalyzerService::identifyDrug()`).
 *
