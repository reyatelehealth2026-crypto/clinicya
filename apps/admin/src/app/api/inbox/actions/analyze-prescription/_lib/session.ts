...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/analyze-prescription
 * Route Handler (port of api/inbox-v2.php's `case 'analyze_prescription': case
 * 'analyze-prescription':`, lines ~281-323, backed by
 * `PharmacyImageAnalyzerService::ocrPrescription()`).
 *
