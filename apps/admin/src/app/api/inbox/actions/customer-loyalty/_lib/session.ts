...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/customer-loyalty
 * Route Handler (port of api/inbox-v2.php's `case 'customer_loyalty': case
 * 'customer-loyalty':`, lines 843-868, backed by
 * `DrugPricingEngineService::getCustomerLoyalty()`).
 *
 ...
 * api/inbox/actions/customer-loyalty/** independently editable from every
 * other action family.
 */
