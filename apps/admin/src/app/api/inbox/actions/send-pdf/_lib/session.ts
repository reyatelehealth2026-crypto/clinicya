...
/**
 * session.ts — auth/tenant-db resolution for the POST /api/inbox/actions/send-pdf Route
 * Handler. Ports the auth gate that guards inbox-v2.php's `case 'send_pdf':` (lines 876-977),
 ...
 * itself.
 *
 * Requires any of the six TenantRole values — `case 'send_pdf':` has no page-specific role
 * restriction beyond "any authenticated admin" (same as send_message/dispense/send_image).
 *
