 ...
 *
 * Local copy of
 * apps/admin/src/app/api/inbox/actions/send-message/_lib/testHelpers/fakeTenantDb.ts (also send-image/_lib/testHelpers/fakeTenantDb.ts)
 ...
 * api/inbox/actions/send-pdf/** independently editable). Test-only
 * code, not worth a cross-feature import.
 */
