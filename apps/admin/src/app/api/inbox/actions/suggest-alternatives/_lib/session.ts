...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/suggest-alternatives
 * Route Handler (port of api/inbox-v2.php's
 * `case 'suggest_alternatives': case 'suggest-alternatives':`, lines ~807-833, backed by
 * `DrugPricingEngineService::suggestAlternatives()`.
 *
