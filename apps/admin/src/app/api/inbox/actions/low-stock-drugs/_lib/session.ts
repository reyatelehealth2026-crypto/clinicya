...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/low-stock-drugs
 * Route Handler (port of api/inbox-v2.php's `case 'low_stock_drugs': case
 * 'low-stock-drugs':`, lines ~1161-1182, backed by
 * `PharmacyIntegrationService::getLowStockDrugs()`).
 *
