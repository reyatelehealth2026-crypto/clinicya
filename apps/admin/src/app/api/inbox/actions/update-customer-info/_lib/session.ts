...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/update-customer-info
 * Route Handler (port of api/inbox-v2.php's `case 'update_customer_info':`,
 * lines ~2165-2196).
 *
 ...
 * api/inbox/actions/update-customer-info/** independently editable from
 * every other action family.
 */
