...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/patient-profile
 * Route Handler (port of api/inbox-v2.php's
 * `case 'patient_profile': case 'patient-profile': case 'get_patient_profile':`, lines ~952-980, backed by
 * `PharmacyIntegrationService::getComprehensivePatientProfile()`).
 *
