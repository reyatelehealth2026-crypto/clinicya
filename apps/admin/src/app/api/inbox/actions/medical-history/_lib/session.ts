...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/medical-history
 * Route Handler (port of api/inbox-v2.php's
 * `case 'medical_history': case 'medical-history': case 'get_medical_history':`, lines ~918-946, backed by
