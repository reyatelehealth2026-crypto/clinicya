...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/analytics
 * Route Handler (port of api/inbox-v2.php's `case 'analytics': case
 * 'get_analytics': case 'consultation_analytics':`, lines ~1681-1786).
 *
