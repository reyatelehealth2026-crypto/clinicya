...
/**
 * session.ts — auth/tenant-db resolution for the /api/inbox/actions/validate-recommendation
 * Route Handler (port of api/inbox-v2.php's
 * `case 'validate_recommendation': case 'validate-recommendation':`, lines ~1052-1081, backed by
 * `PharmacyIntegrationService::validateDrugRecommendation()` — a thin
 * composition of already-ported sibling helpers (see `_lib/validateRecommendation.ts`).
 *
