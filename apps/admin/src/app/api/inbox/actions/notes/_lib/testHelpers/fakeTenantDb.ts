 ...
 * copy too). Test-only code, not worth a cross-feature import. Shared by
 * both route.test.ts (POST, this directory) and [noteId]/route.test.ts
 * (DELETE) — both belong to the "notes" action family.
 *
