<?php
/**
 * NotificationGate — ประตูเดียวก่อนส่งข้อความหาลูกค้า (customer push lane).
 *
 ...
 * "ลูกค้าถอนความยินยอมแล้ว" ถูกเคารพจริง (ความเสี่ยง PDPA)
 *
 * คลาสนี้รวมการตัดสินใจ "ส่งหรือไม่ส่ง" ไว้ที่จุดเดียว แล้วบันทึกทุกครั้ง
 * ทั้งที่ส่งและไม่ส่ง ลง `notification_log` พร้อมเหตุผล
 *
 * ## ขอบเขต — เลน push เท่านั้น
 *
 * Gate นี้คุมเฉพาะข้อความที่ **ร้านเป็นคนเริ่ม** (cron → pushMessage ซึ่งเสียเงิน
