...
// Get selected doc
$selectedDoc = $_GET['doc'] ?? 'SYSTEM_WORKFLOW_COMPLETE.md';
$content = '';
...
<head>
    ...
    <style>
        ...
        h1 { font-size: 2rem; font-weight: 700; margin: 1.5rem 0 1rem; color: #1e40af; border-bottom: 2px solid #3b82f6; padding-bottom: 0.5rem; }
        h2 { font-size: 1.5rem; font-weight: 600; margin: 1.25rem 0 0.75rem; color: #1e3a8a; }
        h3 { font-size: 1.25rem; font-weight: 600; margin: 1rem 0 0.5rem; color: #1e40af; }
        h4 { font-size: 1.125rem; font-weight: 600; margin: 0.75rem 0 0.5rem; color: #374151; }
            ...
            <nav class="space-y-2">
                ...
                <a href="?doc=<?= urlencode($filename) ?>" 
                   class="block px-4 py-3 rounded-lg transition <?= $selectedDoc === $filename ? 'bg-blue-100 text-blue-700 font-medium' : 'hover:bg-gray-100' ?>">
                    <div class="flex items-center gap-3">
                        <i class="fas fa-file-alt <?= $selectedDoc === $filename ? 'text-blue-500' : 'text-gray-400' ?>"></i>
                        <div>
            ...
            <div class="content mx-auto bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="flex items-center justify-between mb-6 pb-4 border-b no-print">
                    ...
                    <div class="flex gap-2">
                        <button onclick="copyToClipboard()" class="px-3 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 text-sm">
                            <i class="fas fa-copy mr-1"></i>Copy
                        </button>
                        <a href="<?= htmlspecialchars($selectedDoc) ?>" download class="px-3 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 text-sm">
